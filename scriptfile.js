...
function createrow(data) {
    ...
    cell4.innerHTML = `<a onclick="onEditClick(this)"style="cursor: pointer;"> <i class="fas fa-edit" style="color:cornflowerblue; background:white; font-size:2vw;"></i></a>  <a onclick="deleterow(this)" style="cursor: pointer;"> <i class="fas fa-trash" style="color:red; background:white; font-size:2vw;"></i></a>`
}
